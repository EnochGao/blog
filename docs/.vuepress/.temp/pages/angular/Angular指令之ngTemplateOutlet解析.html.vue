<template><div><h1 id="angular指令之ngtemplateoutlet解析" tabindex="-1"><a class="header-anchor" href="#angular指令之ngtemplateoutlet解析" aria-hidden="true">#</a> Angular指令之ngTemplateOutlet解析</h1>
...
<p>介绍关于<code v-pre>TemplateRef</code>,<code v-pre>ViewContainerRef</code></p>
</div></template>
