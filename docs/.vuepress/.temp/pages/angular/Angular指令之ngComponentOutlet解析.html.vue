<template><div><h1 id="angular指令之ngcomponentoutlet解析" tabindex="-1"><a class="header-anchor" href="#angular指令之ngcomponentoutlet解析" aria-hidden="true">#</a> Angular指令之ngComponentOutlet解析</h1>
...
<p>可见<code v-pre>ViewContainerRef</code>的强大，下次为大家介绍它。</p>
</div></template>
